# Student Name: Nicole Diamantino
...
print("/n"+"="*50)
print("question 01: Robot Return to Origin")
print("="*50)


def robot_returns_to_origin(moves):  # moves: ud,ll,udlr,etc..
...
def count_characters(s):
    ...
    for char in s:
        if char in counts:  # e = 1 change to===> 2
            counts[char] += 1
        else:
            counts[char] = 1
    return counts
